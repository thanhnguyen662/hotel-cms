...
class UserController {
  register = async (req, res, next) => {
    try {
      ...
      if (isUsernameExist) return res.status(200).json({ message: "username_exist" });
  ...
  delete = async (req, res, next) => {
    try {
      ...
      return res.status(200).json({ ...response, message: "delete_account_success" });
    } catch (error) {
      return next(error);
    }
  };
  ...
  editUserProfile = async (req, res, next) => {
    ...
    try {
      ...
      return res.status(200).json({ ...response, message: "edit_account_success" });
    } catch (error) {
      return next(error);
    }
  };
  ...
  resetPassword = async (req, res, next) => {
    try {
      ...
      if (response) return res.status(200).json({ ...response, message: "reset_password_success" });
    } catch (error) {
      return next(error);
    }
  };
